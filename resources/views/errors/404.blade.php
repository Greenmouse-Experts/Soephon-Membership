            ...
            <div class="row no-gutters height-self-center">
                <div class="col-sm-12 text-center align-self-center">
                    <div class="iq-error position-relative">
                        <img src="{{Url::asset('dash/assets/images/error/Datum_404.png')}}" class="img-fluid iq-error-img iq-error-img-dark mx-auto" alt="">
                        <img src="{{Url::asset('dash/assets/images/error/Datum_404.png')}}" class="img-fluid iq-error-img mb-0" alt="">
